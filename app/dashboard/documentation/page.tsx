...
export default function DocumentationPage() {
  ...
  const getTitle = (id: string) => {
    ...
    return titles[id] || "Documentation";
  };
  ...
  return (
    <>
      <header className="sticky top-0 z-10 bg-background/80 backdrop-blur flex h-16 shrink-0 items-center gap-2 border-b px-4">
        <div className="flex items-center gap-2">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage className="capitalize transition-all duration-300">
                  {getTitle(activeId)}
                </BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
      ...
      <div className="max-w-4xl mx-auto px-6 py-10 space-y-20">
        ...
        <section id="introduction" className="space-y-4">
          ...
          <p>
            The platform allows users to upload videos, store them securely, and
            stream them with optimized performance.
          </p>
        ...
        <section id="get-started" className="space-y-4">
          ...
          <ol className="list-decimal pl-6 space-y-2">
            ...
            <li>
              Click <strong>Publish Video</strong>.
            </li>
          </ol>

          <p className="text-muted-foreground">
            After publishing, your video will appear in the{" "}
            <strong>All Videos</strong> page.
          </p>
        ...
        <section id="tutorials" className="space-y-4">
          ...
          <div className="space-y-4">
            <div className="border rounded-lg p-4">
              ...
              <p className="text-muted-foreground">
                Add a title, description and upload your video using the upload
                form.
              </p>
            </div>
            ...
            <div className="border rounded-lg p-4">
              ...
              <p className="text-muted-foreground">
                View, organize and manage your uploaded videos from the
                dashboard.
              </p>
            </div>
        ...
        <section id="api-reference" className="space-y-4">
          ...
          <p>
            The platform exposes API endpoints for uploading videos and
  ...
  videoUrl: string
        ...
        <section id="changelog" className="space-y-4">
          ...
          <ul className="space-y-2">
            ...
            <li>Video upload functionality added</li>

            <li>Streaming support implemented</li>

            <li>Dashboard and documentation pages created</li>
          </ul>
        </section>
      </div>
    </>
